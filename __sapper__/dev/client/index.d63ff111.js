...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div1, "class", "rectangle w-25 svelte-qalysp");
			add_location(div1, file, 48, 20, 1179);
			...
			add_location(div4, file, 53, 16, 1316);
			if (img.src !== (img_src_value = "time.svg")) attr_dev(img, "src", img_src_value);
			attr_dev(img, "alt", "");
			add_location(img, file, 57, 28, 1556);
			attr_dev(div5, "class", "col");
			add_location(div5, file, 56, 24, 1510);
			attr_dev(div6, "class", "pr-3 text-muted");
			add_location(div6, file, 59, 24, 1643);
			attr_dev(div7, "class", "row text-right");
			add_location(div7, file, 55, 20, 1457);
			attr_dev(div8, "class", "col-md-6");
			add_location(div8, file, 54, 16, 1414);
			attr_dev(div9, "class", "row pt-2 bot-con svelte-qalysp");
			add_location(div9, file, 52, 12, 1269);
