...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h6, file, 21, 12, 474);
			attr_dev(p, "class", "card-text");
			add_location(p, file, 22, 12, 547);
			attr_dev(a0, "href", "#");
			attr_dev(a0, "class", "card-link");
			add_location(a0, file, 23, 12, 679);
			attr_dev(a1, "href", "#");
			attr_dev(a1, "class", "card-link");
			add_location(a1, file, 24, 12, 735);
