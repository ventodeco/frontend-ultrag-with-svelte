...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div1, "class", "rectangle w-50 svelte-huxqu");
			...
			add_location(div4, file, 57, 16, 1389);
			if (img.src !== (img_src_value = "time.svg")) attr_dev(img, "src", img_src_value);
			attr_dev(img, "alt", "");
			add_location(img, file, 61, 28, 1629);
			attr_dev(div5, "class", "col");
			add_location(div5, file, 60, 24, 1583);
			attr_dev(div6, "class", "pr-3 text-muted");
			add_location(div6, file, 63, 24, 1716);
			attr_dev(div7, "class", "row text-right");
			add_location(div7, file, 59, 20, 1530);
			attr_dev(div8, "class", "col-md-6");
			add_location(div8, file, 58, 16, 1487);
			attr_dev(div9, "class", "row pt-2 bot-con svelte-huxqu");
			add_location(div9, file, 56, 12, 1342);
