...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h5, "class", "card-title col svelte-1sgig4j");
			add_location(h5, file, 24, 16, 515);
			attr_dev(h6, "class", "card-subtitle mb-2 text-muted");
			add_location(h6, file, 25, 16, 579);
			attr_dev(div0, "class", "row");
			add_location(div0, file, 23, 12, 481);
			attr_dev(div1, "class", "rectangle");
			add_location(div1, file, 28, 16, 711);
			attr_dev(div2, "class", "row w-100");
			add_location(div2, file, 27, 12, 671);
			attr_dev(p, "class", "card-text");
			add_location(p, file, 32, 12, 798);
			attr_dev(a0, "href", "#");
			attr_dev(a0, "class", "card-link");
			add_location(a0, file, 33, 12, 930);
			attr_dev(a1, "href", "#");
			attr_dev(a1, "class", "card-link");
			add_location(a1, file, 34, 12, 986);
			attr_dev(div3, "class", "card-body");
			add_location(div3, file, 22, 8, 445);
			attr_dev(div4, "class", "card w-100");
			add_location(div4, file, 21, 4, 412);
			attr_dev(div5, "class", "row mt-4");
			add_location(div5, file, 20, 0, 385);
		},
