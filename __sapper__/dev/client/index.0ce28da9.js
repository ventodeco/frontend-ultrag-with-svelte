...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h5, "class", "card-title col svelte-1wxbypt");
			add_location(h5, file, 30, 16, 642);
			attr_dev(h6, "class", "card-subtitle mb-2 text-muted");
			add_location(h6, file, 31, 16, 706);
			attr_dev(div0, "class", "row");
			add_location(div0, file, 29, 12, 608);
			attr_dev(div1, "class", "rectangle svelte-1wxbypt");
			add_location(div1, file, 34, 16, 850);
			attr_dev(div2, "class", "row w-100 text-center");
			add_location(div2, file, 33, 12, 798);
			attr_dev(p, "class", "card-text");
			add_location(p, file, 38, 12, 937);
			attr_dev(a0, "href", "#");
			attr_dev(a0, "class", "card-link");
			add_location(a0, file, 39, 12, 1069);
			attr_dev(a1, "href", "#");
			attr_dev(a1, "class", "card-link");
			add_location(a1, file, 40, 12, 1125);
			attr_dev(div3, "class", "card-body");
			add_location(div3, file, 28, 8, 572);
			attr_dev(div4, "class", "card w-100");
			add_location(div4, file, 27, 4, 539);
