...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div1, "class", "col rectangle w-50 svelte-18tyoq1");
			add_location(div1, file, 47, 20, 1149);
			attr_dev(div2, "class", "col bg-dark");
			...
			add_location(div4, file, 52, 16, 1290);
			if (img.src !== (img_src_value = "time.svg")) attr_dev(img, "src", img_src_value);
			attr_dev(img, "alt", "");
			add_location(img, file, 56, 28, 1530);
			attr_dev(div5, "class", "col");
			add_location(div5, file, 55, 24, 1484);
			attr_dev(div6, "class", "pr-3 text-muted");
			add_location(div6, file, 58, 24, 1617);
			attr_dev(div7, "class", "row text-right");
			add_location(div7, file, 54, 20, 1431);
			attr_dev(div8, "class", "col-md-6");
			add_location(div8, file, 53, 16, 1388);
			attr_dev(div9, "class", "row pt-2 bot-con svelte-18tyoq1");
			add_location(div9, file, 51, 12, 1243);
