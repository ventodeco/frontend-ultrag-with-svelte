...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div1, "class", "rectangle w-25 svelte-18tyoq1");
			add_location(div1, file, 47, 20, 1150);
			...
			add_location(div4, file, 52, 16, 1287);
			if (img.src !== (img_src_value = "time.svg")) attr_dev(img, "src", img_src_value);
			attr_dev(img, "alt", "");
			add_location(img, file, 56, 28, 1527);
			attr_dev(div5, "class", "col");
			add_location(div5, file, 55, 24, 1481);
			attr_dev(div6, "class", "pr-3 text-muted");
			add_location(div6, file, 58, 24, 1614);
			attr_dev(div7, "class", "row text-right");
			add_location(div7, file, 54, 20, 1428);
			attr_dev(div8, "class", "col-md-6");
			add_location(div8, file, 53, 16, 1385);
			attr_dev(div9, "class", "row pt-2 bot-con svelte-18tyoq1");
			add_location(div9, file, 51, 12, 1240);
