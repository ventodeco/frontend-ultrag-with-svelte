...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div1, file, 33, 16, 809);
			attr_dev(div2, "class", "row w-100");
			add_location(div2, file, 32, 12, 769);
			attr_dev(p, "class", "card-text");
			add_location(p, file, 37, 12, 896);
			attr_dev(a0, "href", "#");
			attr_dev(a0, "class", "card-link");
			add_location(a0, file, 38, 12, 1028);
			attr_dev(a1, "href", "#");
			attr_dev(a1, "class", "card-link");
			add_location(a1, file, 39, 12, 1084);
