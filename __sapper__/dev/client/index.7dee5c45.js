...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div5, "class", "col-md-6 text-right");
			add_location(div5, file, 40, 16, 1117);
			attr_dev(div6, "class", "row");
			add_location(div6, file, 38, 12, 996);
			attr_dev(div7, "class", "card-body");
			add_location(div7, file, 27, 8, 552);
			attr_dev(div8, "class", "card w-100");
			add_location(div8, file, 26, 4, 519);
			attr_dev(div9, "class", "row mt-4");
			add_location(div9, file, 25, 0, 492);
		},
