...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div1, "class", "rectangle w-100 svelte-8qldql");
			...
			add_location(a0, file, 38, 12, 994);
			attr_dev(a1, "href", "#");
			attr_dev(a1, "class", "card-link");
			add_location(a1, file, 39, 12, 1050);
