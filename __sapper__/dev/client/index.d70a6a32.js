...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h50, "class", "card-title col-md-6 svelte-hxuifd");
			add_location(h50, file, 45, 16, 925);
			attr_dev(h51, "class", "col-md-6 text-right points svelte-hxuifd");
			add_location(h51, file, 46, 16, 994);
			attr_dev(div0, "class", "row par-points svelte-hxuifd");
			add_location(div0, file, 44, 12, 880);
			attr_dev(div1, "class", "rectangle w-50 svelte-hxuifd");
			add_location(div1, file, 50, 20, 1202);
			attr_dev(div2, "class", "col bg-bar svelte-hxuifd");
			add_location(div2, file, 49, 16, 1157);
			attr_dev(div3, "class", "row text-center mx-1");
			add_location(div3, file, 48, 12, 1106);
			attr_dev(div4, "class", "col-md-6 text-muted");
			add_location(div4, file, 55, 16, 1339);
			if (img.src !== (img_src_value = "time.svg")) attr_dev(img, "src", img_src_value);
			attr_dev(img, "alt", "");
			add_location(img, file, 59, 28, 1579);
			attr_dev(div5, "class", "col");
			add_location(div5, file, 58, 24, 1533);
			attr_dev(div6, "class", "pr-3 text-muted");
			add_location(div6, file, 61, 24, 1666);
			attr_dev(div7, "class", "row text-right");
			add_location(div7, file, 57, 20, 1480);
			attr_dev(div8, "class", "col-md-6");
			add_location(div8, file, 56, 16, 1437);
			attr_dev(div9, "class", "row pt-2 bot-con svelte-hxuifd");
			add_location(div9, file, 54, 12, 1292);
			attr_dev(div10, "class", "card-body");
			add_location(div10, file, 43, 8, 844);
			attr_dev(div11, "class", "card w-100");
			add_location(div11, file, 42, 4, 811);
			attr_dev(div12, "class", "row mt-4 w3-animate-bottom svelte-hxuifd");
			add_location(div12, file, 41, 0, 766);
		},
