...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(h51, "class", "col-md-6 text-right points svelte-qalysp");
			...
			add_location(div1, file, 48, 20, 1171);
			attr_dev(div2, "class", "col-md-12");
			add_location(div2, file, 47, 16, 1127);
			attr_dev(div3, "class", "row text-center");
			add_location(div3, file, 46, 12, 1081);
			attr_dev(div4, "class", "col-md-6 text-muted");
			add_location(div4, file, 53, 16, 1303);
			if (img.src !== (img_src_value = "time.svg")) attr_dev(img, "src", img_src_value);
			attr_dev(img, "alt", "");
			add_location(img, file, 57, 28, 1543);
			attr_dev(div5, "class", "col");
			add_location(div5, file, 56, 24, 1497);
			attr_dev(div6, "class", "pr-3 text-muted");
			add_location(div6, file, 59, 24, 1630);
			attr_dev(div7, "class", "row text-right");
			add_location(div7, file, 55, 20, 1444);
			attr_dev(div8, "class", "col-md-6");
			add_location(div8, file, 54, 16, 1401);
			attr_dev(div9, "class", "row pt-2 bot-con svelte-qalysp");
			add_location(div9, file, 52, 12, 1256);
